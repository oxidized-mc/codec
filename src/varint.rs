...
//! in 1–10 bytes.
//!
//! Part of the packet codec framework (derive macros + wire-type mapping).
...
///
/// ```
/// use oxidized_codec::varint::{encode_varint, VARINT_MAX_BYTES};
///
...
///
/// ```
/// use oxidized_codec::varint::decode_varint;
///
...
/// ```
/// use bytes::BytesMut;
/// use oxidized_codec::varint::write_varint_buf;
///
...
/// use oxidized_codec::varint::{write_varint_buf, read_varint_buf};
///
...
///
/// ```
/// use oxidized_codec::varint::varint_size;
///
