...
/// use oxidized_codec::types::{write_string, read_string};
///
...
/// ```
/// use bytes::BytesMut;
/// use oxidized_codec::types::write_string;
///
...
/// ```
/// use bytes::{Bytes, BytesMut};
/// use oxidized_codec::types::{write_uuid, read_uuid};
///
...
/// ```
/// use bytes::BytesMut;
/// use oxidized_codec::types::write_uuid;
///
/// let id = uuid::Uuid::nil();
/// let mut buf = BytesMut::new();
